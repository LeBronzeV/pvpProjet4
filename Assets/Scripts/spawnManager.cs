...
public class spawnManager : MonoBehaviour {
	...
	void Update () {
        ...
        if (m_timer > spawnDeltaTime){
            ...
            if (nombreSbire < 3){
                nombreSbire++;
                GameObject.Instantiate(sbireTL, spawnLT.transform.position, Quaternion.identity);
                GameObject.Instantiate(sbireBL, spawnLB.transform.position, Quaternion.identity);
                GameObject.Instantiate(sbireTR, spawnRT.transform.position, Quaternion.identity);
                GameObject.Instantiate(sbireBR, spawnRB.transform.position, Quaternion.identity);
            }
        }
    }
}
